    ...
    connectedCallback() {
        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <p><strong>Email:</strong> <a href="mailto: arima@arimataberna.eus">arima@arimataberna.eus</a></p>
                <p><strong>Abierto todos los días</strong></p>
            </div>
            
            <div class="footer-section">
                <h3>Nuestra Ubicación</h3>
                <p>Osina kalea 4, Zabaleta Berri auzoa, Lasarte-Oria, 20160</p>
        ...
        <div class="footer-bottom">
            &copy; 2022 Arima Taberna. Todos los derechos reservados.
        </div>
    </footer>
        `;
    }
